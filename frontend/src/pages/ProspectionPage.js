      ...
      {displayStats && (
        <div className="stats-grid" style={{ marginBottom: 16 }}>
          {[
            ...
            { key: 'validees_dev',    label: '✅ Visitées',      value: (displayStats.validees_dev||0) + (displayStats.puce_attribuees||0) + (displayStats.activees||0) + (displayStats.refusees||0), variant: null, legende: 'Prospects dont la visite est terminée (validées + attribuées + activées + refusées)' },
