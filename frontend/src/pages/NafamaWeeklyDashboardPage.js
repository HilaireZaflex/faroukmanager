...
import {
  Home, Trophy, BarChart3, TrendingUp, TrendingDown, AlertTriangle, Target
} from 'lucide-react';
...
function OngletProgression({ annee, semaine }) {
  const { data, isLoading } = useQuery(
    [`nafama-w-progression`, annee, semaine],
    ...
    <div className="page">
      <div className="page-header" style={{ marginBottom: 20 }}>
        <div>
          ...
          <p style={{ color: '#8a8a9a', fontSize: 13, marginTop: 4 }}>Suivi semaine par semaine du réseau NAFAMA</p>
        </div>
